...
export function GeckoTerminalEmbed({ 
  ...
  const chartBg = '0b0d12'
  const embedUrl = `https://www.geckoterminal.com/${finalNetwork}/${endpoint}/${finalAddress}?embed=1&info=0&swaps=0&grayscale=0&light_chart=${theme === 'light' ? '1' : '0'}&volume=0&header=0&branding=0&watermark=0&logo=0&attribution=0&powered_by=0&bg_color=${chartBg}&utm_source=&utm_medium=&utm_campaign=`
